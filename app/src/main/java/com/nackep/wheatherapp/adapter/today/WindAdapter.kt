...
class WindAdapter(var hourList: ArrayList<Hour>) : RecyclerView.Adapter<WindAdapter.WindHolder>() {
    class WindHolder(var binding: RowWindBinding) : RecyclerView.ViewHolder(binding.root)
